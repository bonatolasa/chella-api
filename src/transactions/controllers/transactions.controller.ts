...
export class TransactionsController{
  ...
  async makeTransfer(
    ...
    const result = await this.transactionsService.makeTransfer(req.user, transferDto);
    return result;
  }
  ...
  async getTransactionHistory(
    ...
    const result = await this.transactionsService.getTransactionHistory(req.user);
    return result;
  }
